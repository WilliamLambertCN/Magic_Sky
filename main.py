...
# mask_path='d:/projects/DIP/Final_Project/Unet/results/0_pred_gray_img.png'
sky_path = 'd:/projects/DIP/Final_Project/Unet/sky/' + sky_num + '.jpg'

def sky_replace(img_path, sky_path):
...
# cv2.imwrite('d:/projects/DIP/Final_Project/Unet/Demo/xxx.png', final)
